...
## COMPARACIÓN
Basandonos en el accuracy de la hoja 3 (del árbol de clasificación), es mejor el árbol de clasificación al algoritmo de Bayes. Además en términos de procesamiento, ambos duraron casi la misma cantidad de tiempo, por lo tanto, es mejor el algoritmo del árbol de clasificación al de Bayes.
